...
\centering
\includegraphics[width=\textwidth]{./mp.JPG}
\caption{Construction of accessible moldering privy at Grout Pond with crib underneath and shelter on top.}
\label{fig:mp}
\end{minipage}\hfill
\begin{minipage}{0.45\textwidth}
\centering
\includegraphics[width=\textwidth]{./cg.JPG}
\caption{Maintainers visit the privy at the Cooley Glen shelter in the spring to sift and disperse the fully composted material from one chamber of the crib.}
\label{fig:cg}
\end{minipage}
\end{figure} _/
...
\begin{minipage}{0.45\textwidth}
\centering
\includegraphics[width=\textwidth]{./jt.jpg}
\caption{Maintainer empties sewage from the catcher into rectangular storage containers behind. Lily LaRegina/Green Mountain Club 2023.}
\label{fig:jt}
\end{minipage}\hfill
\begin{minipage}{0.45\textwidth}
\centering
\includegraphics[width=\textwidth]{./btb.png}
\caption{Schematic of BTB system to separate and treat liquid waste.}
\label{fig:catcher}
\end{minipage}
\end{figure}
