...
A moment is a turning force around a fixed pivot. If something is balanced, the moments are equal and opposite. The size of a moment is determined by the force (N) and distance (m). The distance is the perpendicular distance from the pivot to the force.
...
- smooth surface - one force acting normal to the surface
- rope/cable - one colinear force acting along the axis of the rope or cable
- link - one colinear force acting along the axis of the link
- roller - one force acting normal to the surface on which the roller rests
- fixed collar - one force acting perpendicular to the sleeve and one moment
- pin - two force components acting parallel to the coordinate axes
...
- smooth surface - one force acting normal to the surface
- rope/cable - one colinear force acting along the axis of the rope or cable
- roller - one force acting normal to the surface
- bearing (circular shaft) - two force components acting parallel to the coordinate axes and two moments perpendicular to the axis of the bearing
- hinge - three force components acting parallel to the coordinate axes and two moments perpendicular to the axis of the bearing
- fixed - three force components acting parallel to the coordinate axes, and three moments perpendicular to the axis of the bearing
