...
In essence, the task for this project is to design and fabricate a board game in which we apply our AutoCAD and SolidWorks skills. After some individual and group brainstorming, we wrote up a README for our game idea.
